...
7. On the Resource groups blade, you should see a resource group named DP-300-Lab01-XXXXXX. 
...
3. On the Create a virtual machine blade, enter the following information: 
	...
	- Resource group: Select the existing resource group from the drop down menu **DP-300-Lab01**
...
6. Navigate to the Management tab and review the configuration. 
	...
	Verify that **Enable auto_shutdown** is off or not checked. 
