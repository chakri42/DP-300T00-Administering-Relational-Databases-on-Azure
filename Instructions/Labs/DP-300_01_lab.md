...
7. On the Resource groups blade, you should see a resource group named **DP-300-Lab01-<inject key="DeploymentID" enableCopy="false"/>**
...
3. On the Create a virtual machine blade, enter the following information: 
	...
	- Resource group: Select the existing resource group from the drop down menu **DP-300-Lab01-<inject key="DeploymentID"></inject>**
...
9. Once the database restore completes, a dialog box will appear with the message **"Database 'AdventureWorksDW2017' restored successfully"**. Select the **OK*8 button.
