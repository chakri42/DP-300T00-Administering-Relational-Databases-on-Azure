...
10. To further verify the container backups has been created, execute the following, where *dp300storage-XXXXXX* is the storage account name used you created and *storage_key* is the key you generated above. 
 **Replace XXXXXX with the Suffix value provided in the environment details page**
