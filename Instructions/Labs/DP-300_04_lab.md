...
6. Repeat the above steps 3,4 and 5 for the restoring the database **WideWorldImporters**
   For step 4,In the Local Backup File dialog select **WideWorldImporters.bak** file from C:\LabFiles folder and select the **OK** button. 

7. Copy and paste the code below into your query window. 
...
14.  Navigate back to the query tab you opened in step 4, and type ROLLBACK TRANSACTION on the line below the query. Highlight ROLLBACK TRANSACTION and execute the command.

  ![Picture 19](../images/dp-3300-module-44-lab-13.png)
 
15. Navigate back to the query tab you opened in Step 5. You will notice that the query has now completed.

16. Close all your query windows.
